...
> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:evidence-driven-drafting to implement this plan task-by-task.
...
Invoke the superpowers:interrogate skill and follow it exactly as presented to you
```
...
Invoke the superpowers:story-plan skill and follow it exactly as presented to you
```
...
**After (Narrative):**
1. `/superpowers:interrogate` → story prospectus
2. `/superpowers:story-plan` → research & drafting plan
3. `/superpowers:evidence-driven-drafting` → research with fact-checking
4. `/superpowers:peer-scrutiny` → editorial + ethical review
...
Start with `/superpowers:interrogate` on your next story idea.
```
...
> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:evidence-driven-drafting
