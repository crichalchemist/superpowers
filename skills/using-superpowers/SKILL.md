...
2. **Planning skills second** (writing-plans, superpowers:story-plan) - break work into tasks  
3. **Execution skills third** (subagent-driven-development, superpowers:evidence-driven-drafting) - implement/research
4. **Verification always** (test-driven-development, superpowers:fact-check-driven-revision) - verify before claims

**Examples:**

*Code:* "Let's build X" → brainstorming → writing-plans → subagent-driven-development + test-driven-development

*Story:* "I noticed something strange" → brainstorming → superpowers:story-plan → superpowers:evidence-driven-drafting + superpowers:fact-check-driven-revision
